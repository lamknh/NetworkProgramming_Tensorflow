...
public class FileTransferSender extends Thread{
    ...
    public void run() {
        try {
            ...
            InputStream in = socket.getInputStream();		// socket 생
            ...
            FileInputStream fin = new FileInputStream("/Users/yong/pLibrary/NP_maven_tensorflow/src/main/java/client/"+fileNameMsg);
